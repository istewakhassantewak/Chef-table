...
const Header = () => {
    return (
        <header className="md:container mx-auto p-4">
            <nav>
            ...
            <div
                ...
                <p className="font-normal text-lg">Learn and Master Basic Programming, Data Structures, Algorithm, OOP, Database and solve 500+ coding <br /> problems to become an exceptionally well world-class Programmer.</p>
